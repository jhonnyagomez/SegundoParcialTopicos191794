...
class FormularioFragment : Fragment() {
    ...
    private fun validation(nombre :String, img :String , principal: Int, secundario : Int) : Boolean{
        if(nombre.isEmpty()){
